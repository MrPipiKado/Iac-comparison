...
class ApplicationLayerStack(NestedStack):
    ...
    def __init__(self, scope: Construct, construct_id: str,
                 app_vpc: ec2.IVpc, alb_subnets: List[ec2.ISubnet],
                 lb_sg: ec2.ISecurityGroup, app_sg: ec2.ISecurityGroup,
                 env_name: str, config: dict, **kwargs) -> None:
        super().__init__(scope, construct_id, **kwargs)

        self.template = ec2.LaunchTemplate(self, "LaunchTemplate",
        ...
        self.app_asg = autoscaling.AutoScalingGroup(self, "ASG",
            vpc=app_vpc,
